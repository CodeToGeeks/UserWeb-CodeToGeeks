...
const TermsAndConditions = () => {
  return (
    <main className={styles.container}>
      <SEO
        title="Terms and Conditions | Code To Geeks"
        description="Terms and Conditions for code to geeks website"
      />
      <h1 className="title-underline">Terms and Conditions</h1>
      <p>Welcome to CodeToGeeks!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of CodeToGeeks&apos;s Website, located at https://codetogeeks.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use CodeToGeeks if you do not agree to
      ...
      <p>
        ...
        &rdquo;Client&rdquo;, &rdquo;You&rdquo; and &rdquo;Your&rdquo; refers to
        you, the person who logs on this website and is compliant to the
        Company’s terms and conditions. &rdquo;The Company&rdquo;,
        &rdquo;Ourselves&rdquo;, &rdquo;We&rdquo;, &rdquo;Our&rdquo; and
        &rdquo;Us&rdquo;, refers to our Company. &rdquo;Party&rdquo;,
        &rdquo;Parties&rdquo;, or &rdquo;Us&rdquo;, refers to both the Client
        ...
        Company’s stated services, under and subject to, prevailing law of
      ...
      <p>
        We employ the use of cookies. By accessing CodeToGeeks, you agreed to
        use cookies in agreement with CodeToGeeks&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, CodeToGeeks and/or its licensors own the
        intellectual property rights for all material on CodeToGeeks. All
        intellectual property rights are reserved. You may access this from
        CodeToGeeks for your personal use subject to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from CodeToGeeks</li>
        <li>Sell, rent or sub-license material from CodeToGeeks</li>
        <li>Reproduce, duplicate or copy material from CodeToGeeks</li>
        <li>Redistribute content from CodeToGeeks</li>
      </ul>
      ...
      <p>
        ...
        CodeToGeeks does not filter, edit, publish or review Comments before
        their presence on the website. Comments do not reflect the views and
        opinions of CodeToGeeks, its agents, and/or affiliates. Comments reflect
        the views and opinions of the person who posts their views and opinions.
        To the extent permitted by applicable laws, CodeToGeeks shall not be
      ...
      <p>
        CodeToGeeks reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant CodeToGeeks a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of CodeToGeeks, and (d) the link
      ...
      <p>
        ...
        e-mail to CodeToGeeks. Please include your name, your organization name,
      ...
      <p>
        No use of CodeToGeeks&apos;s logo or other artwork will be allowed for
