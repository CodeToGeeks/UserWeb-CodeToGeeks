...
const PrivacyPolicy = () => {
  return (
    <main className={styles.container}>
      <SEO
        title="Privacy Policy | Code To Geeks"
        description="Privacy policy for code to geeks website"
      />
      <h1 className="title-underline">Privacy Policy for CodeToGeeks</h1>

      <p>
        At CodeToGeeks, accessible from https://codetogeeks.com/, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        CodeToGeeks and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in CodeToGeeks. This policy is not applicable to
      ...
      <p>
        CodeToGeeks follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, CodeToGeeks uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertising partners of CodeToGeeks.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on CodeToGeeks, which are sent
      ...
      <p>
        Note that CodeToGeeks has no access to or control over these cookies
      ...
      <p>
        CodeToGeeks&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        CodeToGeeks does not knowingly collect any Personal Identifiable
